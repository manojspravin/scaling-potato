...
def equity(connection_check):
    ...
    if nowTime < startTime:
        ...
        SuperLiveSegment.objects.all().delete()
        EquityThree.objects.all().delete()
    ...
    if nowTime > startTime and nowTime < market_stop_time:
        ...
        try:
            ...
            fnolist = ["AARTIIND","ABB","ABBOTINDIA","ACC","ADANIPORTS","ALKEM","AMBUJACEM","APOLLOHOSP","ASIANPAINT","ATUL","AUBANK","AUROPHARMA","AXISBANK","BAJAJ-AUTO",
                    "BAJAJFINSV","BAJFINANCE","BALKRISIND","BALRAMCHIN","BANDHANBNK","BATAINDIA","BERGEPAINT","BHARATFORG","BHARTIARTL","BOSCHLTD","BPCL","BRITANNIA","BSOFT","CANFINHOME",
                    "CHAMBLFERT","CHOLAFIN","CIPLA","COFORGE","COLPAL","CONCOR","COROMANDEL","CROMPTON","CUMMINSIND","DABUR","DALBHARAT","DEEPAKNTR","DIVISLAB","DIXON","DLF","DRREDDY",
                    "EICHERMOT","ESCORTS","GLENMARK","GNFC","GODREJCP","GODREJPROP","GRANULES","GRASIM","GUJGASLTD","HAVELLS","HCLTECH","HDFC","HDFCAMC","HDFCBANK","HDFCLIFE","HINDALCO",
                    "HINDUNILVR","ICICIBANK","ICICIGI","ICICIPRULI","IGL","INDHOTEL","INDIAMART","INDIGO","INDUSINDBK","INFY","INTELLECT","IPCALAB","IRCTC","ITC","JINDALSTEL","JSWSTEEL",
                    "JUBLFOOD","KOTAKBANK","LAURUSLABS","LICHSGFIN","LT","LTIM","LTTS","LUPIN","M&M","MARICO","MARUTI","MCDOWELL-N","MCX","METROPOLIS","MFSL","MGL","MPHASIS","MRF",
                    "MUTHOOTFIN","NAUKRI","NAVINFLUOR","OBEROIRLTY","OFSS","PEL","PERSISTENT","PIDILITIND","PIIND","POLYCAB","PVR","RAMCOCEM","SBICARD","SBILIFE","SBIN","SHREECEM","SHRIRAMFIN",
                    "SRF","SUNPHARMA","SUNTV","SYNGENE","TATACHEM","TATACOMM","TATACONSUM","TATAMOTORS","TCS","TECHM","TITAN","TORNTPHARM","TRENT","TVSMOTOR","UBL","ULTRACEMCO","UPL","VEDL",
